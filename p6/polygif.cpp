...
#include "poly1.h"        // Provides polynomial class definition
...
namespace main_savitch_4 {
    ...
    void write_gif_header128(ostream& out, int width, int height, const /*unsigned*/ char color_table[128][3]) {
    ...
    void make_gif(const polynomial& p, const char filename[ ], double low_x, double high_x, double low_y, double high_y) {
		...
		const /*unsigned*/ char COLOR_TABLE[128][3] = {
		    {'\000', '\000', '\000' },  // BLACK
